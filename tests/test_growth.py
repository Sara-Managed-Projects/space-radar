...
Spec 0002 requirement 3 and its acceptance test. This applies `tests/fixtures/miranda.yaml`
...
def main() -> int:
    fixture = yaml.safe_load((ROOT / "tests/fixtures/miranda.yaml").read_text(encoding="utf-8"))
