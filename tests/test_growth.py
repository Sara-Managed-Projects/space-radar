...
Spec 0002 requirement 3 and its acceptance test. This applies `tests/fixtures/phoebe.yaml`
...
def main() -> int:
    fixture = yaml.safe_load((ROOT / "tests/fixtures/phoebe.yaml").read_text(encoding="utf-8"))
