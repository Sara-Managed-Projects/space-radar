...
export const SOURCES = {
  ...
  'nasa-exoplanet-archive': {
    ...
    registryId: 'nasa-exoplanet-archive',
    label: 'NASA Exoplanet Archive — confirmed planets',
    publisher: 'Caltech/IPAC for NASA',
    url: 'https://exoplanetarchive.ipac.caltech.edu/TAP/sync?query=select+pl_name,hostname,ra,dec,sy_dist,pl_rade,pl_bmasse,pl_orbper,disc_year,discoverymethod,st_teff,st_rad,st_spectype+from+pscomppars&format=csv',
    cadenceMs: 168 * HOUR,
    freshnessMaxMs: 720 * HOUR,
    browser: false,
    kind: 'text',
    attribution: 'Exoplanets: NASA Exoplanet Archive (Caltech/IPAC), DOI 10.26133/NEA13',
    note: NO_CORS_REASON + ' Read from our snapshot; without one the layer shows the dated copy bundled in site/data/exoplanets.csv and says so.',
  },
  'jpl-cad': {
    id: 'jpl-cad',
    registryId: 'jpl-cad',
